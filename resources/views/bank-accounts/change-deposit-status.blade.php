...
@section('content')
    <div class="container m-auto">
        <h2>Change Status</h2>
        <hr>
        <form action="{{ route('bank-deposit.status.update', $bankDeposit) }}" method="post">
            @csrf
            ...
            <a href="{{ route('bank-account.show', $bankDeposit->bankAccount) }}" class="btn btn-warning float-right">Cancel</a>
        </form>
    </div>
@endsection
