...
@section('content')
    <div class="container m-auto">
        <h2>Change Status</h2>
        <hr>
        <form action="{{ route('bank-withdraw.status.update', $bankWithdraw) }}" method="post">
            @csrf
            ...
            <a href="{{ route('bank-account.show', $bankWithdraw->bankAccount) }}" class="btn btn-warning float-right">Cancel</a>
        </form>
    </div>
@endsection
